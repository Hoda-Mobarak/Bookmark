...
if (localStorage.getItem("bookmarksList")) {
  ...
  function displayBookmark(indexOfWebsite) {
    ...
    // Adding Click Event to all delete buttons every time a user add a new bookmark
    ...
    //  Adding Click Event to All visit buttons every time a user add a new bookmark
